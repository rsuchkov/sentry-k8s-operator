...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "3d72626b.io.x42r",
	...
	setupLog.Info("Initializing Sentry client")
	sc := sentrysetup.SentrySetup{
		Token:   os.Getenv("SENTRY_AUTH_TOKEN"),
		BaseURL: os.Getenv("SENTRY_BASE_URL"),
	}
	sentryClient, err := sc.InitializeSentryClient(
		context.Background(),
	)
	if err != nil {
		setupLog.Error(err, "unable to initialize Sentry client")
		os.Exit(1)
	}
